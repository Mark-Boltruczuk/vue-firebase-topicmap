        ...
        <v-layout row wrap>
          <v-flex d-flex xs12 mb-0>
            <v-card class="blue-grey darken-2" dark>
              ...
              <v-card-text>Title: {{topicMap !== undefined? topicMap.name : ""}}</v-card-text>
              <v-card-text>Description: {{topicMap !== undefined ? topicMap.description : ""}}</v-card-text>
              <v-card-text>Subject: {{topicMap !== undefined ? topicMap.subject : ""}}</v-card-text>
...
<script>
import { Circleui } from "./circleMap";
